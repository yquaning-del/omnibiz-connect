  ...
  public: {
    Tables: {
      ...
      amenity_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "amenity_requests_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "amenity_requests_reservation_id_fkey"
          ...
          {
            foreignKeyName: "amenity_requests_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
      ...
      guest_folios: {
        Row: {
          ...
          guest_name: string
          id: string
          incidental_charges: number | null
          location_id: string
          notes: string | null
          organization_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "guest_folios_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "guest_folios_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "guest_folios_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      guest_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "guest_profiles_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "guest_profiles_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      hotel_rooms: {
        Row: {
          ...
          id: string
          is_ota_available: boolean | null
          location_id: string
          notes: string | null
          ota_markup_percent: number | null
          price_per_night: number
          room_number: string
          room_type: string
          seasonal_rate: Json | null
          status: string
          updated_at: string
      ...
      room_service_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "room_service_orders_folio_id_fkey"
            columns: ["folio_id"]
            isOneToOne: false
            referencedRelation: "guest_folios"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "room_service_orders_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "room_service_orders_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      user_permissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_permissions_user_role_id_fkey"
